...
print('Relative interpolation error X: ',err_int)
print('Relative extrapolation error X: ',err_ext)
...
print('Relative interpolation error Closure: ',err_int)
print('Relative extrapolation error Closure: ',err_ext)
